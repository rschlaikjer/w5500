...
enum class State { START, DISCOVER, REQUEST, LEASED, RENEW };

enum class DhcpOperation : uint8_t { REQUEST = 1, REPLY = 2 };
...
#define BRK(X)                                                                 \
  ...
  public:
    size_t consume(uint8_t *data, size_t size) {
        ...
        // Xid: u32
        case 4:
            xid |= (data[4 - _offset] << 24);
            BRK(4);
        case 5:
            xid |= (data[5 - _offset] << 16);
            BRK(5);
        case 6:
            xid |= (data[6 - _offset] << 8);
            BRK(6);
        case 7:
            xid |= (data[7 - _offset]);
            BRK(7);
        ...
        // Flags: u16
        case 10:
            flags |= (data[10 - _offset] << 8);
            BRK(10);
        case 11:
            flags |= (data[11 - _offset]);
            BRK(11);
        // Ciaddr
        case 12:
            ciaddr[0] = data[12 - _offset];
            BRK(12);
        case 13:
            ciaddr[1] = data[13 - _offset];
            BRK(13);
        case 14:
            ciaddr[2] = data[14 - _offset];
            BRK(14);
        case 15:
            ciaddr[3] = data[15 - _offset];
            BRK(15);
        // Yiaddr
        case 16:
            yiaddr[0] = data[16 - _offset];
            BRK(16);
        case 17:
            yiaddr[1] = data[17 - _offset];
            BRK(17);
        case 18:
            yiaddr[2] = data[18 - _offset];
            BRK(18);
        case 19:
            yiaddr[3] = data[19 - _offset];
            BRK(19);
        // Siaddr
        case 20:
            siaddr[0] = data[20 - _offset];
            BRK(20);
        case 21:
            siaddr[1] = data[21 - _offset];
            BRK(21);
        case 22:
            siaddr[2] = data[22 - _offset];
            BRK(22);
        case 23:
            siaddr[3] = data[23 - _offset];
            BRK(23);
        // Giaddr
        case 24:
            giaddr[0] = data[24 - _offset];
            BRK(24);
        case 25:
            giaddr[1] = data[25 - _offset];
            BRK(25);
        case 26:
            giaddr[2] = data[26 - _offset];
            BRK(26);
        case 27:
            giaddr[3] = data[27 - _offset];
            BRK(27);
        // Chaddr
        case 28:
            chaddr[0] = data[28 - _offset];
            BRK(28);
        case 29:
            chaddr[1] = data[29 - _offset];
            BRK(29);
        case 30:
            chaddr[2] = data[30 - _offset];
            BRK(30);
        case 31:
            chaddr[3] = data[31 - _offset];
            BRK(31);
        case 32:
            chaddr[4] = data[32 - _offset];
            BRK(32);
        case 33:
            chaddr[5] = data[33 - _offset];
        }
